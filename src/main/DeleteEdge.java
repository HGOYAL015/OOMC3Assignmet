...
public class DeleteEdge extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Edge FromVertex and ToVertex");
    ...
    private void addEdgeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addEdgeActionPerformed
        ...
        if (from.equals(to)) {
            ...
            try {
                ...
                int res = JOptionPane.showConfirmDialog(null, "Are You Sure to Delete this Edge");
                if (res == 0) {
                    OOM.G.deleteEdge(from, to);
                    JOptionPane.showMessageDialog(null, "Successfull Deletion");
//                    this.dispose();
                    
                } else {
                    JOptionPane.showMessageDialog(null, "You Cancelled Your Delete Operation");                    
                }
